...
<@layout.registrationLayout displayMessage=!messagesPerField.existsError('username','password') displayInfo=realm.password && realm.registrationAllowed && !registrationDisabled??; section>
    ...
    <#elseif section = "form">
        <div id="kc-form">
        <#if !properties.hideLoginPassword?? || properties.hideLoginPassword?? && properties.hideLoginPassword != "true">
            ...
            <div id="kc-social-providers" class="${properties.kcFormSocialAccountSectionClass!}">
                ...
                <ul class="${properties.kcFormSocialAccountListClass!} <#if social.providers?size gt 3>${properties.kcFormSocialAccountListGridClass!}</#if>">
                    <#list social.providers as p>
                        <li>
                            <a id="social-${p.alias}" class="socialbutton <#if social.providers?size gt 3>${properties.kcFormSocialAccountGridItem!}</#if>"
